...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Meliodas\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5547989152194:+55 47 989152194\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '*'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] Dani? Este é um recurso especial para o Dani ou Chaplin❌',
					ownerB: '[❗] Dani? Este é um recurso especial para o Dani ou Chaplin❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmão. Você não está registrado como amigo do Dani. Registre-se para fazer amizade com o bot ✞︎Dani/Xandao✞︎ por meio, \n\nCommand : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar ✞︎Dani✞︎|17\n\n──「 BOT MAN 」──`,
			...
			const ownerNumber = ["55989152194@s.whatsapp.net","55989152194@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"55989152194@s.whatsapp.net","55989152194@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["55989152194@s.whatsapp.net","55989152194@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["55989152194@s.whatsapp.net","55989152194@s.whatsapp.net"]//ubah nomor lo
			const premium = ["55989152194@s.whatsapp.net","55989152194@s.whatsapp.net","55989152194@s.whatsapp.net","558981213553@s.whatsapp.net","554999498331@s.whatsapp.net"]
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("fdp")){
       ...
       if (messagesC.includes("oi")){
			...
			if (messagesC.includes("@55989152194")){
			client.updatePresence(from, Presence.composing)
        ...
        case 'promover':
				...
				case 'bemvindo':
					...
					if (Number(args[0]) === 1) {
						...
						reply('Ativou com sucesso o recurso de boas-vindas neste grupo @danigostozo😉️')
					} else if (Number(args[0]) === 0) {
